...
export class Migration1761912147640 implements MigrationInterface {
  name = 'Migration1761912147640'

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.dropColumn('snapshot', 'buildRunnerId')
    await queryRunner.dropColumn('snapshot', 'internalName')
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`
      ALTER TABLE "snapshot" ADD "buildRunnerId" character varying;
      ALTER TABLE "snapshot" ADD "internalName" character varying;

      UPDATE "snapshot"
      SET
        "buildRunnerId" = "initialRunnerId",
        "internalName" = "ref";
    `)
  }
}
