...
function SidebarGroupLabel({ ref, className, render, ...props }: useRender.ComponentProps<'div'>) {
  const defaultProps = {
...
function SidebarGroupAction({ ref, className, render, ...props }: useRender.ComponentProps<'button'>) {
  const defaultProps = {
...
const sidebarMenuButtonVariants = cva(
  'peer/menu-button flex w-full items-center px-2 gap-2 overflow-hidden rounded-md text-left text-sm outline-hidden ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:text-sidebar-accent-foreground data-[active=true]:bg-muted data-popup-open:hover:bg-sidebar-accent data-popup-open:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:!size-8 group-data-[collapsible=icon]:!py-2 group-data-[collapsible=icon]:!px-2 [&>span:last-child]:truncate [&>svg]:shrink-0',
  {
    variants: {
      variant: {
        default: 'hover:bg-sidebar-accent hover:text-sidebar-accent-foreground',
        outline:
          'border border-border bg-transparent shadow-none hover:bg-sidebar-accent hover:text-sidebar-accent-foreground dark:bg-input/50',
      },
      size: {
        default: 'h-8 text-sm',
        sm: 'h-7 text-xs',
