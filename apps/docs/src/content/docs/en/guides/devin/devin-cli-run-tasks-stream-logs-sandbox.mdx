---
title: Run the Devin CLI in a Daytona Sandbox
description: Step-by-step guide to running Cognition's Devin CLI as a coding agent inside Daytona sandboxes and returning its task output to the caller.
---
