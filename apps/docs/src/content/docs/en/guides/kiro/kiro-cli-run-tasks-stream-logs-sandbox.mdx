---
title: Run AWS Kiro's CLI in a Daytona Sandbox and Stream Its Output
description: Step-by-step guide to running AWS Kiro's CLI as a coding agent inside Daytona sandboxes and streaming its task output back to the caller.
---
...
cd daytona/guides/typescript/kiro/kiro-cli
```
