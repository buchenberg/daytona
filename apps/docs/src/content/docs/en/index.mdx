...
Generate an API key from the [Daytona Dashboard ↗](https://app.daytona.io/dashboard/keys). Set the `DAYTONA_API_KEY` in the shell environment or in environment files.
