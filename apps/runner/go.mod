...
require (
	...
	github.com/daytonaio/daytona/libs/netleash v0.0.0
...
// netleash is an in-repo module that is not published with version tags, so it
// is resolved from the local path rather than fetched from the daytona repo.
replace github.com/daytonaio/daytona/libs/netleash => ../../libs/netleash
