...
module DaytonaApiClient
  class OrganizationsApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [Organization]
    def get_organization_by_sandbox_id_deprecated(sandbox_id, opts = {})
      data, _status_code, _headers = get_organization_by_sandbox_id_deprecated_with_http_info(sandbox_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Organization, Integer, Hash)>] Organization data, response status code and response headers
    def get_organization_by_sandbox_id_deprecated_with_http_info(sandbox_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OrganizationsApi.get_organization_by_sandbox_id_deprecated ...'
      end
      # verify the required parameter 'sandbox_id' is set
      if @api_client.config.client_side_validation && sandbox_id.nil?
        fail ArgumentError, "Missing the required parameter 'sandbox_id' when calling OrganizationsApi.get_organization_by_sandbox_id_deprecated"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"OrganizationsApi.get_organization_by_sandbox_id_deprecated",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrganizationsApi#get_organization_by_sandbox_id_deprecated\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [RegionQuota]
    def get_region_quota_by_sandbox_id_deprecated(sandbox_id, opts = {})
      data, _status_code, _headers = get_region_quota_by_sandbox_id_deprecated_with_http_info(sandbox_id, opts)
      data
    end
    ...
    def get_region_quota_by_sandbox_id_deprecated_with_http_info(sandbox_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OrganizationsApi.get_region_quota_by_sandbox_id_deprecated ...'
      end
      # verify the required parameter 'sandbox_id' is set
      if @api_client.config.client_side_validation && sandbox_id.nil?
        fail ArgumentError, "Missing the required parameter 'sandbox_id' when calling OrganizationsApi.get_region_quota_by_sandbox_id_deprecated"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"OrganizationsApi.get_region_quota_by_sandbox_id_deprecated",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: OrganizationsApi#get_region_quota_by_sandbox_id_deprecated\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
